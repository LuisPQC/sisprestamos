                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{$cliente->nombres}}" class="form-control" name="nombres" placeholder="Escriba aquí..." disabled>
                                    </div>
                                    @error('nombres')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{$cliente->apellidos}}" class="form-control" name="apellidos" placeholder="Escriba aquí..." disabled>
                                    </div>
                                    @error('apellidos')
                                    <small style="color: red">{{$message}}</small>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" value="{{$cliente->fecha_nacimiento}}" class="form-control" name="fecha_nacimiento" placeholder="Escriba aquí..." disabled>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{$cliente->genero}}" class="form-control" name="genero" placeholder="Escriba aquí..." disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
