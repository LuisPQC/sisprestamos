                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped table-sm">
                        ...
                        @foreach($backups as $backup)
                            <tr>
                                ...
                                <td style="text-align: center">{{date('Y-m-d H:i:s',Storage::lastModified($backup))}}</td>
                                <td style="text-align: center">
                                    <a href="{{url('/admin/backups/descargar/'.basename($backup))}}" class="btn btn-success"><i class="fas fa-download"></i> Descargar</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
